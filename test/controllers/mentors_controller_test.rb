...
class MentorsControllerTest < ActionController::TestCase
  ...
  test "should create mentor" do
    assert_difference('Mentor.count') do
      post :create, mentor: { country_id: @mentor.country_id, first_name: @mentor.first_name, last_name: @mentor.last_name, university_id: @mentor.university_id }
    end
  ...
  test "should update mentor" do
    patch :update, id: @mentor, mentor: { country_id: @mentor.country_id, first_name: @mentor.first_name, last_name: @mentor.last_name, university_id: @mentor.university_id }
    assert_redirected_to mentor_path(assigns(:mentor))
  end
